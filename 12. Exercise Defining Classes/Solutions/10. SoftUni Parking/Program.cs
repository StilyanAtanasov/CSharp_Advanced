...
public class StartUp
{
    ...
    {
        // Sample Code Usage
        Car car = new("Skoda", "Fabia", 65, "CC1856BG");
        Car car2 = new("Audi", "A3", 110, "EB8787MN");
        ...
        parking.RemoveSetOfRegistrationNumber(new List<string> { "notExistingRegistrationNumber", "EB83837MV" });
